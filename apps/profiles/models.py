...
class Profile(TimeStampedUUIDModel):
    ...
    top_agent=models.DecimalField(max_digits=4, decimal_places=2, null=True, blank=True)
    num_review = models.IntegerField(verbose_name=_("Number of Reviews"), default=0, null=True, blank=True)
